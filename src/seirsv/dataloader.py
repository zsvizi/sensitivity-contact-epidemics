...
class seirSVDataLoader:
    ...
    def _get_age_data(self):
        """
        1980 England and Wales population is used.
        it is divided into 15 age groups
        :return:
        """
    ...
    def _get_contact_mtx(self):
        """
        this is 15 * 15 contact matrix with the last age group, 70+
        :return:
        """
    ...
    def transform_matrix(self, matrix: np.ndarray):
        ...
        age_distribution = self.age_data.reshape((-1, 1))   # (15, 1)

        # Get matrix of total number of contacts
        matrix_1 = matrix * age_distribution        # (15, 15)
