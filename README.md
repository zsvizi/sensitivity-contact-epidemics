...
![Flowchart of Project Methodology](src/flowchart.pdf)

## Folder Structure
├── data                # Data for the models.
├── src                 # Directory for source files.    
│   ├── examples        # Implementation of various epidemic models.
...
│   ├── model           # Base classes for models and R0 calculation.
│   │   ├── model_base          # Base class for epidemic models.
│   │   ├── r0_generator_base   # Framework for calculating R0 in epidemic models.
│   ├── prcc            # PRCC (Partial Rank Correlation Coefficient) calculations.
...
│   ├── sampling        # Sampling methods and calculations.
│   │   ├── target      # Classes for calculating and sampling.
...
│   ├── simulation      # Simulation management and analysis.
